...
Source manifest: `build/asset-manifest/ios_asset_manifest.json`
...
| Asset | References |
|---|---:|
| `Maps/IOSPlayableSlice/IOSPlayableSlice.map` | 1 |

### models

| Asset | References |
|---|---:|
| `AirF_AmericaParticleCannonUplink.w3d` | 1 |
| `AmericaParticleCannonUplink.w3d` | 1 |
| `Boss_GLAScudStorm.w3d` | 1 |
| `Boss_NuclearMissileLauncher.w3d` | 1 |
| `Boss_ParticleCannonUplink.w3d` | 1 |
| `Chem_GLAScudStorm.w3d` | 1 |
| `ChinaNuclearMissileLauncher.w3d` | 1 |
| `Demo_GLAScudStorm.w3d` | 1 |
| `GarrisonGun.w3d` | 1 |
| `GLAScudStorm.w3d` | 1 |
| `Infa_ChinaNuclearMissileLauncher.w3d` | 1 |
| `IOSBarracks.w3d` | 1 |
| `IOSBeacon.w3d` | 1 |
| `IOSCommandCenter.w3d` | 1 |
| `IOSDozer.w3d` | 1 |
| `IOSGenericBridge.w3d` | 1 |
| `IOSGenericDebris.w3d` | 1 |
| `IOSPowerPlant.w3d` | 1 |
| `IOSRallyPointMarker.w3d` | 1 |
| `IOSRanger.w3d` | 1 |
| `IOSScoutVehicle.w3d` | 1 |
| `IOSWaterWaveBridge.w3d` | 1 |
| `Lazr_AmericaParticleCannonUplink.w3d` | 1 |
| `Nuke_ChinaNuclearMissileLauncher.w3d` | 1 |
| `Slth_GLAScudStorm.w3d` | 1 |
| `SupW_AmericaParticleCannonUplink.w3d` | 1 |
| `Tank_ChinaNuclearMissileLauncher.w3d` | 1 |
| `WaveHit01.w3d` | 1 |
| `WaveSplash01.w3d` | 1 |
| `WaveSplashLeft01.w3d` | 1 |
| `WaveSplashRight01.w3d` | 1 |
| `WaveSpray01.w3d` | 1 |
| `WaveSpray02.w3d` | 1 |
| `WaveSpray03.w3d` | 1 |
...
| `SunHalo.tga` | 2 |
| `SunLensFlare.tga` | 2 |
| `Data/Art/Textures/IOSAmmoEmptyIcon.tga` | 1 |
| `Data/Art/Textures/IOSAmmoFullIcon.tga` | 1 |
| `Data/Art/Textures/IOSBarracksIcon.tga` | 1 |
| `Data/Art/Textures/IOSBeaconIcon.tga` | 1 |
| `Data/Art/Textures/IOSCancelIcon.tga` | 1 |
| `Data/Art/Textures/IOSCivilianSideIcon.tga` | 1 |
| `Data/Art/Textures/IOSCommandCenterIcon.tga` | 1 |
| `Data/Art/Textures/IOSCommunicatorIcon.tga` | 1 |
| `Data/Art/Textures/IOSContainerEmptyIcon.tga` | 1 |
| `Data/Art/Textures/IOSContainerFullIcon.tga` | 1 |
| `Data/Art/Textures/IOSDozerIcon.tga` | 1 |
| `Data/Art/Textures/IOSExitIcon.tga` | 1 |
| `Data/Art/Textures/IOSFactionEnabled.tga` | 1 |
| `Data/Art/Textures/IOSFactionGeneral.tga` | 1 |
| `Data/Art/Textures/IOSFactionSideIcon.tga` | 1 |
| `Data/Art/Textures/IOSFlagWaterMark.tga` | 1 |
| `Data/Art/Textures/IOSGeneralPowersIcon.tga` | 1 |
| `Data/Art/Textures/IOSHeadWaterMark.tga` | 1 |
| `Data/Art/Textures/IOSIdleWorkerIcon.tga` | 1 |
| `Data/Art/Textures/IOSLoadScreen.tga` | 1 |
| `Data/Art/Textures/IOSMapPreview.tga` | 1 |
| `Data/Art/Textures/IOSObserverSideIcon.tga` | 1 |
| `Data/Art/Textures/IOSOptionsIcon.tga` | 1 |
| `Data/Art/Textures/IOSPowerPlantIcon.tga` | 1 |
| `Data/Art/Textures/IOSRallyPointIcon.tga` | 1 |
| `Data/Art/Textures/IOSRangerIcon.tga` | 1 |
| `Data/Art/Textures/IOSScoreScreen.tga` | 1 |
| `Data/Art/Textures/IOSScoutVehicleIcon.tga` | 1 |
| `Data/Art/Textures/IOSSelectAllIcon.tga` | 1 |
| `Data/Art/Textures/IOSSellIcon.tga` | 1 |
| `Data/Art/Textures/IOSStarBronze.tga` | 1 |
| `Data/Art/Textures/IOSStarGold.tga` | 1 |
| `Data/Art/Textures/IOSStarRedYellow.tga` | 1 |
| `Data/Art/Textures/IOSStarSilver.tga` | 1 |
| `Data/Art/Textures/IOSStopIcon.tga` | 1 |
| `Data/Art/Textures/IOSToggleControlBarIcon.tga` | 1 |
...
| Asset | References |
|---|---:|
| `Data/Window/ControlBar.wnd` | 1 |
| `Data/Window/controlBarHidden.wnd` | 1 |
| `Data/Window/ControlBarPopupDescription.wnd` | 1 |
| `Data/Window/GeneralsExpPoints.wnd` | 1 |
| `Data/Window/InGameChat.wnd` | 1 |
| `Data/Window/InGamePopupMessage.wnd` | 1 |
| `Data/Window/Menus/BlankWindow.wnd` | 1 |
| `Data/Window/Menus/ChallengeLoadScreen.wnd` | 1 |
| `Data/Window/Menus/CRCMismatch.wnd` | 1 |
| `Data/Window/Menus/Defeat.wnd` | 1 |
| `Data/Window/Menus/DisconnectScreen.wnd` | 1 |
| `Data/Window/Menus/ExtrasMenu.wnd` | 1 |
| `Data/Window/Menus/GameSpyLoadScreen.wnd` | 1 |
| `Data/Window/Menus/LegalPage.wnd` | 1 |
| `Data/Window/Menus/LocalDefeat.wnd` | 1 |
| `Data/Window/Menus/MainMenu.wnd` | 1 |
| `Data/Window/Menus/MapTransferScreen.wnd` | 1 |
| `Data/Window/Menus/MessageBox.wnd` | 1 |
| `Data/Window/Menus/MultiplayerLoadScreen.wnd` | 1 |
| `Data/Window/Menus/ObserverQuit.wnd` | 1 |
| `Data/Window/Menus/OptionsMenu.wnd` | 1 |
| `Data/Window/Menus/PopupCommunicator.wnd` | 1 |
| `Data/Window/Menus/PopupReplay.wnd` | 1 |
| `Data/Window/Menus/PopupSaveLoad.wnd` | 1 |
| `Data/Window/Menus/QuitMenu.wnd` | 1 |
| `Data/Window/Menus/QuitMessageBox.wnd` | 1 |
| `Data/Window/Menus/QuitNoSave.wnd` | 1 |
| `Data/Window/Menus/ScoreScreen.wnd` | 1 |
| `Data/Window/Menus/ShellGameLoadScreen.wnd` | 1 |
| `Data/Window/Menus/SinglePlayerLoadScreen.wnd` | 1 |
| `Data/Window/Menus/Victorious.wnd` | 1 |
| `Data/Window/MOTD.wnd` | 1 |
| `Data/Window/ReplayControl.wnd` | 1 |
